        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (price.isEmpty() || price.equals("Total Cost : 0.0")) {
                    Toast.makeText(CartBuyMedicineActivity.this, "Cart is empty. Please add items.", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (date.equals("Select Deliver Date")) { // Default button text
                    Toast.makeText(CartBuyMedicineActivity.this, "Please select a date.", Toast.LENGTH_SHORT).show();
                    return;
                }
